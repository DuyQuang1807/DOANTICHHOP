...
public class DatabaseItem {
    ...
    public void getAll(final ItemCallback callback) {
        final ArrayList<Model> dataloai = new ArrayList<>();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot data : snapshot.getChildren()){
                        Model categories = data.getValue(Model.class);
...
//    public boolean update(final Model item){
